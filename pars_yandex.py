...
def parsing_data(data_result, r):
    ...
    try:
        ...
        return None
    try:
        summary_rating__main = reviews.find(
    ...
    if reviews_list:
        ...
        for review in reviews_list:
            try:
                review_name = review.find('div', {"itemprop": "author"}).find(
            ...
            try:
                review_text = review.find(
                    'span', {"class": "business-review-view__body-text"}).text
            except:
                review_text = None
            try:
                star_count = get_count_star(review.find(
...
def get_data_from_yandex(yandex_id, name_shop):
