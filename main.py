...
def get_filtered_and_cleaned_reviews_from_files_yandex(date_start="2010-01-01", date_end="2010-01-01"):
    ...
    for shop in shops:
        ...
        if reviews_of_shop: 
            result.extend(clear_reviews(shop["name"], reviews_of_shop, date_start, date_end))
...
date_end="2022-07-01"
reviews = get_filtered_and_cleaned_reviews_from_files_yandex(date_start, date_end)
